...
import com.furkanmulayim.golden.core.component.buttons.CustomPrimaryButton
import com.furkanmulayim.golden.core.component.buttons.CustomSecondaryButton
import com.furkanmulayim.golden.ui.theme.AppSize

@Composable
fun ButtonSection(
    doIncestingOnClick: () -> Unit,
    exchangeRateOnClick: () -> Unit
) {
